    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            templates: {
                ...
                filterWrap:'<span class"filter-wrap"></span',
        ...
        buildDropdownOptions: function() {
            ...
            if (this.options.enableCollapsibleOptGroups && this.options.multiple) {
                ...
                $("li.multiselect-group > a > b", this.$ul).on("click", $.proxy(function(t) {
                    ...
                    n.toggleClass('opened', i);

                    if(i) {
                         var scrollHeight = 0;

                        n.prevAll(':not(.filter):not(.hidden)').each(function() {
                            scrollHeight += $(this).outerHeight(true);
                        });

                        $('.multiselect-container').animate({scrollTop: scrollHeight}, 800);
                    }
                ...
                $("li input", this.$ul).on("change", $.proxy(function(t) {
                    ...
                    if (!n.hasClass('multiselect-group')) {
                        n.prevAll('.multiselect-group').eq(0).find('input').prop('checked', i);
                    }
                }, this));
        ...
        createOptgroup: function(group) {            
            if (this.options.enableCollapsibleOptGroups && this.options.multiple) {
                ...
                var r = $('<li class="multiselect-item multiselect-group"><a href="javascript:void(0);"><input type="checkbox" value="' + value + '"/><b> <label>' + label + '</label><b class="caret"></b></b></a></li>');
                    ...
                    this.$filter.val(this.query).on('click', function(event) {
                        ...
                        this.searchTimeout = this.asyncFunction($.proxy(function() {
                            ...
                            if (this.query !== event.target.value) {
                                ...
                                if(this.query !== '') {
                                    $('.multiselect-all').addClass('hidden');
                                    $('.sub').removeClass('hidden');
                                    $('.multiselect-group.multiselect-group-clickable').addClass('opened');
                                } else {
                                    $('.multiselect-all').removeClass('hidden');
                                    $('.sub').addClass('hidden');
                                    $('.multiselect-group.multiselect-group-clickable').removeClass('opened');
                                }
                            }
        ...
        triggerChange: function(optionInputs) {
            this.options.onChange(optionInputs, true);
        },
